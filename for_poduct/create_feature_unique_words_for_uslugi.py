...
def main():
    print('Start parsing in a uslugi files')
    directory = '..//data//data_uslugi'
    ...
    if not os.path.isdir("..//data//csv_s//uslugi"):
        os.mkdir("..//data//csv_s//uslugi")
    ...
    print('Finish parsing in a uslugi files')
