...
def main():
    print('Start parsing in a postavka files')
    directory = '..//data//data_postavka'
    ...
    if not os.path.isdir("..//data//csv_s//postavka"):
        os.mkdir("..//data//csv_s//postavka")
    ...
    print('Finish parsing in a postavka files')
