...
def main():
    print('Start parsing in a podriad files')
    directory = '..//data//data_podriad'
    ...
    if not os.path.isdir("..//data//csv_s//podriad"):
        os.mkdir("..//data//csv_s//podriad")
    ...
    print('Finish parsing in a podriad files')
