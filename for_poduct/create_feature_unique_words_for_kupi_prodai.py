...
def main():
    print('Start parsing in a kupi-prodai files')
    directory = '..//data//data_kupi_prodai'
    ...
    if not os.path.isdir("..//data//csv_s//kupi_prodai"):
        os.mkdir("..//data//csv_s//kupi_prodai")
    ...
    save_path = '..//data//csv_s//kupi_prodai'
    ...
    """
    print('Finish parsing in a kupi-prodai files')
